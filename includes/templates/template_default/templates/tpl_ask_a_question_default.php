...
<?php echo '<a href="' . zen_href_link(zen_get_info_page((int)$pid), 'products_id=' . (int)$pid, 'SSL') . '">' . zen_image(DIR_WS_IMAGES . $product_details['products_image'], $product_details['products_name'], zen_config('IMAGE_PRODUCT_LISTING_WIDTH'), zen_config('IMAGE_PRODUCT_LISTING_HEIGHT')) . '</a>'; ?>
